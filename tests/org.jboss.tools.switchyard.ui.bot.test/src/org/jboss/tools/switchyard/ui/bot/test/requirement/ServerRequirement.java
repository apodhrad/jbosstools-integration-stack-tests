package org.jboss.tools.switchyard.ui.bot.test.requirement;
...
public class ServerRequirement extends ServerReqBase 
			implements Requirement<SYServer>, CustomConfiguration<ServerRequirementConfig> {
...
//		setupServerState(server.state(), lastServerConfiguration);
	...
	private void setupServerAdapter(){
		...
		NewServerWizardPage swpage = swd.getFirstPage();
	...
	@Override
	public void setDeclaration(SYServer server) {
		this.server = server;
	}
